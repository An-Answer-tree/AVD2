...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config"):
        ...
        parser.add_argument("--max_seq_length", default=210, type=int,
                            help="The maximum total input sequence length after tokenization.")
        parser.add_argument("--max_seq_a_length", default=105, type=int,
                            help="The maximum sequence length for caption.")
        parser.add_argument("--max_img_seq_length", default=196, type=int,
        ...
        parser.add_argument("--max_masked_tokens", type=int, default=315,
    ...
    def shared_video_captioning_config(self, cbs=False, scst=False):
        ...
        self.parser.add_argument('--mask_img_feat', type=str_to_bool,
                                 nargs='?', const=True, default=False,
                                 help='Enable image feature masking')
        self.parser.add_argument('--max_masked_img_tokens', type=int, default=700,
                                 help="Maximum masked object features")
        ...
        self.parser.add_argument("--drop_worst_ratio", default=0, type=float,
                                 help="Drop worst ratio.")
        self.parser.add_argument("--drop_worst_after", default=0, type=int,
                                 help="Drop worst after N steps.")
        self.parser.add_argument('--max_gen_length', type=int, default=105,
        ...
        self.parser.add_argument('--num_return_sequences', type=int, default=1,
                                 help="Number of sequences to return per image")
    ...
    def self_critic_args(self):
        ...
        self.parser.add_argument('--sc_train_sample_n', type=int, default=5,
                                 help="Number of sampled captions for SCST training")
...
def restore_training_settings(args):
    ...
    if hasattr(args, 'scst') and args.scst:
